...
client.write_coil(0x00, False, slave = 0x0004)
time.sleep(0.5)

ssrStatus = client.read_coils(0x00, slave = 0x0004)
print(f"ssr: {ssrStatus.bits[0]}")

client.write_coil(0x00, True, slave = 0x0004)
time.sleep(0.5)
